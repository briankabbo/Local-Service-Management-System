...
<head>
  ...
  <title>Local Service Management System || Dashboard</title>
...
?>
            <div class="small-box bg-success">
              ...
              <a href="manage-person.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
