...
<head>
  ...
  <title>Local Service Management System || Update Person Detail</title>
...
<option value="<?php echo htmlentities($row1->Category);?>"><?php echo htmlentities($row1->Category);?></option>
 <?php } ?> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" value="<?php echo htmlentities($row->MobileNumber);?>" maxlength="11" pattern="[0-9]+" required="true">
                  </div> 
                  <div class="form-group">
