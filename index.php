...
<head>
	...
	<title>Local Service Management System || Home Page</title>
			...
			<div class="fullwidthbanner-container">
				<div class="revolution-slider tx-center">
					<ul><!-- SLIDE  -->
						...
						<!-- MAIN IMAGE -->
							<img src="images/banner.jpg" alt="item slide">
						<!-- LAYERS -->	
...
<option value="<?php echo htmlentities($row->Category);?>"><?php echo htmlentities($row->Category);?></option>
 <?php } ?> 
						...
						<div class="submit-field-wrap pull-right">
							<input class="search-form-submit bgyallow-1 white" name="search" type="submit" value="Serach"/>
						</div>
					</form>
				</div>
			</div>
