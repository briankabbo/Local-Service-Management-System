...
{               ?>
                                    ...
                                    <li class="toolbar-contact"><i class="fa fa-phone"></i> +880<?php  echo htmlentities($row->MobileNumber);?></li><?php $cnt=$cnt+1;}} ?>
            ...
            <div class="nav-wrapper"><!--main navigation-->
                <div class="container">
                    ...
                    <nav class="wsmenu slideLeft clearfix">
                        <div class="logo pull-left"><a href="index.php" title="Responsive Slide Menus"><h3 style="color:#08c2f3">LSMS</h3></a></div>
