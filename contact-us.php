...
<head>
  ...
  <title>Local Service Management System || Contact Us</title>
...
{               ?>
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Page Title</label><input type="text" name="pagetitle" id="pagetitle" required="true" value="<?php  echo $row->PageTitle;?>" class="form-control"></div>
                                    ...
                                    <div class="form-group"><label for="vat" class=" form-control-label">Mobile Number</label><input type="text" name="mobnum" id="mobnum" required="true" value="<?php  echo $row->MobileNumber;?>" maxlength="11" patttern="[0-9]+" class="form-control"></div>
